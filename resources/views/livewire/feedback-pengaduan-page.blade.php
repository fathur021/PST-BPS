<div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
	...
	<div class="mx-auto max-w-xl lg:max-w-4xl">
		...
		<div x-data="{ show: false }" x-init="setTimeout(() => show = true, 300)" 
		     ...
		     :class="{ 'invisible': !show, 'relative': show, 'absolute': !show }"><h2 class="text-4xl font-bold tracking-tight text-gray-900 text-center">Feedback Pengaduan</h2>
		</div>
		...
		<div x-data="{ show: false }" x-init="setTimeout(() => show = true, 700)" 
			...
			@livewire('feedback-pengaduan.feedback-form')
		</div>
	</div>
</div>
